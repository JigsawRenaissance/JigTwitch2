...
#ifdef DEBUG
 /* This line tweets to TwitchTest1 account */
  sprintf(buffer,"GET /update/?axk=4dcb52b03be27&status=%s HTTP/1.1\nHost: twitter.alixsys.com\n\n",urlEscape(tweet));
#else
 /* This line tweets to the JigTwitch account */
